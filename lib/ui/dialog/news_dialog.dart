...
class NewsDialog extends StatefulWidget {
  final News? news;
  const NewsDialog({super.key, this.news});
...
class _NewsDialogState extends State<NewsDialog> {
  ...
  void initState() {
    ...
    if (news != null) {
      ...
      _visibleFrom = news.visibleFrom;
      _visibleTo = news.visibleTo;
      if (news.imageUrl != null && news.imageUrl!.isNotEmpty) {
        _loadNetworkImage(news.imageUrl!);
      }
    }
  }
  ...
  Future<String?> _uploadImageToSupabase(
    ...
    final fileName = 'news_${const Uuid().v4()}.$fileExt';
                  ...
                  Column(
                    children: [
                      ...
                      if (isEditing &&
                        ...
                        Image.network(widget.news!.imageUrl!, height: 100),
                      ],
              ...
              ElevatedButton(
                ...
                onPressed: () async {
                  ...
                  if (_formKey.currentState!.validate()) {
                    ...
                    if (isEditing) {
                      await provider.updateNews(news.id, news);
                    } else {
                      await provider.addNews(news);
                    }
